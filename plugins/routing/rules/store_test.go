...
func TestRuleStore_CreateAndRetrieve(t *testing.T) {
	...
	rule1 := &configstoreTables.TableRoutingRule{
		...
		Fallbacks:       nil,
		ParsedFallbacks: []configstoreTables.RoutingFallback{{Provider: "azure", Model: "gpt-4-turbo"}},
		Scope:           "global",
		ScopeID:         nil,
		Priority:        10,
		CreatedAt:       time.Now(),
	...
	rule2 := &configstoreTables.TableRoutingRule{
		...
		Fallbacks:       nil,
		ParsedFallbacks: []configstoreTables.RoutingFallback{{Provider: "groq", Model: "mixtral-8x7b"}},
		Scope:           "team",
		ScopeID:         &teamID,
		Priority:        20,
		CreatedAt:       time.Now(),
