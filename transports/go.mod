...
require (
	...
	github.com/maximhq/bifrost/plugins/compat v0.3.0
	github.com/maximhq/bifrost/plugins/governance v1.8.0
	github.com/maximhq/bifrost/plugins/logging v1.8.0
	github.com/maximhq/bifrost/plugins/maxim v1.7.3
	github.com/maximhq/bifrost/plugins/modelcatalogresolver v1.1.3
	github.com/maximhq/bifrost/plugins/otel v1.5.3
	github.com/maximhq/bifrost/plugins/prompts v1.1.3
	github.com/maximhq/bifrost/plugins/routing v1.1.0
	github.com/maximhq/bifrost/plugins/semanticcache v1.6.3
	github.com/maximhq/bifrost/plugins/telemetry v1.7.0
